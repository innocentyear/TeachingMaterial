...
namespace TeachingMaterial
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<TeachingMaterialDbContext>()));
            // 配置用户名的验证逻辑
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<ApplicationRole>(context.Get<TeachingMaterialDbContext>()));
        }
    }
